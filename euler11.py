...
for line in grid:
	...
	while i <= 16:
		...
		#print(str(line[i]) + " x " + str(line[i+1]) + " x " + str(line[i+2]) + " x " + str(line[i+3]))
...
print("Largest horizontally: " + str(largest))
maxes.append(largest)

# Scan 4 squares vertically
largest = 0

i = 0 # index of top line
j = 0 # index of column
...
while i <= 16:
	...
	while j < 20:
		...
		#print(str(grid[i][j]) + " x " + str(grid[i+1][j]) + " x " + str(grid[i+2][j]) + " x " + str(grid[i+3][j]))
...
print("Largest vertically: " + str(largest))
maxes.append(largest)



# Scan 4 squares diagonally neg gradient
...
while i <= 16:
	...
	while j <= 16:
		...
		#print(str(grid[i][j]) + " x " + str(grid[i+1][j+1]) + " x " + str(grid[i+2][j+2]) + " x " + str(grid[i+3][j+3]))
...
# Scan 4 squares diagonally pos gradient	
	
i = 0 # index of top line
j = 19 # index of column
...
print("\nLargest overall is: " + str(max(maxes)))